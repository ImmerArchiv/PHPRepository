...
$checksum = $bagman->CalculateChecksum($bagit,$name);

if($checksum == null)
	$request->error('HTTP/1.0 400 Bad Request','error while calculating checksum');

$request->ok('HTTP/1.0 200 Ok','checksum is following', $checksum);
